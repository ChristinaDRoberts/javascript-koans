...
describe("About Higher Order Functions", function () {
  ...
  it("should use 'map' to transform each element", function () {
    var numbers = [1, 2, 3];
    //this means take each item in array, add one and return value then go onto next item, return a new array
  ...
  //do more research on chain and flatten and when i can use them 
